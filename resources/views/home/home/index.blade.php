                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <a href="project-overview.html" class="avatar avatar-4by3">
                                        <img src="{{asset('org/')}}/assets/img/avatars/projects/project-1.jpg" alt="..."
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <!-- Avatar -->
                                    <a href="project-overview.html" class="avatar avatar-4by3">
                                        <img src="{{asset('org/')}}/assets/img/avatars/projects/project-2.jpg" alt="..."
                                             class="avatar-img rounded">
                                    </a>
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <!-- Avatar -->
                                    <a href="project-overview.html" class="avatar avatar-4by3">
                                        <img src="{{asset('org/')}}/assets/img/avatars/projects/project-3.jpg" alt="..."
                                             class="avatar-img rounded">
                                    </a>
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <!-- Avatar -->
                                    <a href="project-overview.html" class="avatar avatar-4by3">
                                        <img src="{{asset('org/')}}/assets/img/avatars/projects/project-5.jpg" alt="..."
                                             class="avatar-img rounded">
                                    </a>
