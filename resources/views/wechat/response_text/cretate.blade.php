        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('wechat.response_text.index')}}" class="card-title d-inline-block text-muted">回复列表</a>
                            <a href="{{route('wechat.response_text.create')}}" class="card-title d-inline-block text-primary" style="margin-left: 2%">添加回复</a>
                            {{--<p class="card-description">--}}
                                {{--Basic form elements--}}
                            {{--</p>--}}
                            <form class="forms-sample" method="post" action="{{route('wechat.response_text.store')}}">
                                                        @csrf
